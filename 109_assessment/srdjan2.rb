...
=begin
local var a is assigned Integer 4 on line 1, and local var b is assigned Integer 2 on line 2.
...
=begin
  ...
  the return value of #puts is always nil, and #map replaces each element in the array with the return value of the block. thus, the return value is [nil,nil,nil,nil]
=end